...
if __name__ == "__main__":
    ...
    random = Greedy(protein_sequences[-1], dimension = 3)
    random = HillClimber(protein_sequences[-1], dimension = 3)
    random = SimulatedAnnealing(protein_sequences[-1], dimension = 3)
    random.run(show_plot = True, iterations = 100)
    pass